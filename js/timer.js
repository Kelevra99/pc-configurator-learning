...
// Массив с блоками таймера для централизованного управления стилями отображения
...
const updateTimer=()=>{
    ...
    // Сбрасываем цвет текста, если таймер продолжает работу
    timerBlocks.forEach((block)=>{ block.style.color='' })
    ...
    // Подсвечиваем нули красным цветом при завершении отсчёта
    timerBlocks.forEach((block)=>{ block.style.color='red' })
    return
  }
}
